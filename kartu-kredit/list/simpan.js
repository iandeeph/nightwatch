...
exports['kartu-kredit.list.simpan'] = function (browser) {
  var email = 'kristian@cermati.com';
  var password = 'testercermati';

  var btnSignin = 'body > div.wrapper.header-fixed > div.header.new-header > div > div > div.collapse.navbar-collapse.navbar-responsive-collapse.nomargin.text-right > span:nth-child(2) > a';
  ...
  var btnSigninLast = '#modal-auth > div > div > div.auth-box.modal-pane-signin.hiddens > div.modal-body > form > button';
	...
	var labelSelectorAllCards1 = '#scrollbar4 > div:nth-child(5) > div > div > a';
  var label1 = 'HSBC Visa Platinum Card';
	...
	var labelSelectorAllCards2 = '#scrollbar4 > div:nth-child(1) > div > div > a';
  ...
  var label4 = 'Garuda Indonesia Citi Card';
	...
	var labelSelectorAllCards5= '#scrollbar4 > div:nth-child(6) > div > div > a';
  var label5 = 'HSBC Visa Signature Card';
	...
	var labelSelectorAllCards6 = '#scrollbar4 > div:nth-child(2) > div > div > a';
  var label6 = 'Citi Rewards Card';
	...
	var btnTambahkan = '#save-creditCard > div:nth-child(1) > button';
